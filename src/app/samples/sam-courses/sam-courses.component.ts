...
@Component({
  selector: 'app-sam-courses',
  templateUrl: './sam-courses.component.html',
  styleUrls: ['./sam-courses.component.css']
})
export class SamCoursesComponent implements OnInit {
  ...
  onSearchRadio(data: string){
    this.selectedSearchValue = data;
